...
java -cp target\tunnel-1.0-SNAPSHOT.jar com.tunnel.server.TunnelServerApp 7000
```

2. Start the proxy client (connects to tunnel server and requests proxy port 8080):

```powershell
java -cp target\tunnel-1.0-SNAPSHOT.jar com.tunnel.client.TunnelClientApp 127.0.0.1 7000 8080
```
